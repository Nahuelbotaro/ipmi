...
void dibujarCuadrados(float posX, float posY, color colorOscuro, color colorClaro, float angulo) {
  ...
  for (int i = 0; i < cantidad; i++) {
    ...
    float tamano = calcularTamano(i, cantidad, tamanoInicial);
...
float calcularTamano(int i, int cantidad, float tamanoInicial) {
